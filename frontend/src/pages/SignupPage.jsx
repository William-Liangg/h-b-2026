        ...
        <div className="relative z-10 flex flex-col justify-between w-full px-12 py-12">
          ...
          <div className="flex-1 flex flex-col justify-center">
            <h2 className="text-4xl text-white mb-6 leading-tight font-bold tracking-tight">
              Get up to speed on any codebase.
            </h2>
            <p className="text-zinc-400 text-lg leading-relaxed">
              Create an account to start analyzing repos with AI-powered importance scoring, guided walkthroughs, and interactive dependency graphs.
            </p>
          </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-6">
            <div className="space-y-2 text-center">
              ...
              <p className="text-zinc-400">Create a new account to get started with Atlas.</p>
            </div>
